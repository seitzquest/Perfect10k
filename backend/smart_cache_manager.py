...
class SmartCacheManager:
    ...
    def get_cached_graph(self, lat: float, lon: float) -> Optional[nx.MultiGraph]:
    ...
    def get_scoring_weights(self, preference: str) -> Optional[CachedScoringWeights]:
    ...
    def get_candidate_pool(self, area_key: str) -> Optional[CandidatePool]:
