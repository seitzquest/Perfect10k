...
def main():
    ...
    for tile_file in tile_files:
        ...
        print(f"{tile_file.name}: {geom_count}/{edge_count} edges have geometry ({percentage:.1f}%)")
    ...
    if total_edges > 0:
        ...
        if overall_percentage < 10:
            ...
            print("✅ Solution: Regenerate cache with geometry using the load_osm_with_geometry.py script")
        else:
