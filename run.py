...
def main():
    ...
    try:
        ...
        backend_thread = threading.Thread(
            ...
            args=(backend_process, "Backend", manager)
        )
        frontend_thread = threading.Thread(
            target=monitor_process, 
            args=(frontend_process, "Frontend", manager)
        )
        ...
        print_colored("   Frontend: https://localhost:3000", Colors.BLUE)
        print_colored("   Backend:  https://localhost:8000", Colors.BLUE)
        print_colored("   API Docs: https://localhost:8000/docs", Colors.BLUE)
        print()
        print_colored("💡 Open https://localhost:3000 in your browser", Colors.YELLOW)
